...
export default function NewAnalysisPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      {/* Navigation */}
      <nav className="bg-slate-900/80 backdrop-blur-sm border-b border-slate-800 px-6 py-3 sticky top-0 z-10">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <button
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-xl border border-slate-800 bg-slate-900/50 hover:border-blue-500/40 hover:bg-slate-900 transition duration-200"
              >
                <svg
              ...
              <button
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-xl border border-slate-800 bg-slate-900/50 hover:border-orange-500/40 hover:bg-slate-900 transition duration-200"
              >
                <svg
                ...
                <span className="font-semibold text-white">GitLab</span>
                <span className="text-xs text-slate-500">
              ...
              <button
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-xl border border-slate-800 bg-slate-900/50 hover:border-green-500/40 hover:bg-slate-900 transition duration-200"
              >
                <svg
              ...
              <button
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-xl border border-slate-800 bg-slate-900/50 hover:border-cyan-500/40 hover:bg-slate-900 transition duration-200"
              >
                <svg
                ...
                <span className="font-semibold text-white">Grant Access</span>
                <span className="text-xs text-slate-500">
        ...
        {provider === "github" && (
          <div>
            <button
              ...
              className="text-slate-400 hover:text-white text-sm mb-6 block transition"
            >
                      ...
                      <form onSubmit={handleSavePAT} className="space-y-3">
                        <div>
                          <input
                            ...
                            required
                            className="w-full px-4 py-2.5 bg-slate-800 border border-slate-600 rounded-lg text-sm font-mono text-white placeholder:text-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                          />
            ...
            <form onSubmit={handleConnect} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 bg-slate-800 border border-slate-600 rounded-lg text-white placeholder:text-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between bg-slate-900 border border-slate-700 rounded-lg px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-slate-300">Token active</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <svg
                    ...
                    <span
                      className={`text-sm font-mono ${
                        countdown < 120 ? "text-amber-400" : "text-slate-400"
                      }`}
                    >
                ...
                <div>
                  ...
                  <div className="relative group">
                    <div className="bg-slate-950 border border-slate-700 rounded-lg p-4 font-mono text-sm text-green-400 overflow-x-auto">
                    ...
                    <button
                      ...
                      className={`absolute top-3 right-3 px-3 py-1.5 rounded-md text-xs font-medium transition ${
                        commandCopied
                          ...
                          : "bg-slate-800 text-slate-400 border border-slate-600 hover:text-white hover:border-slate-500"
                      }`}
                    >
                ...
                {/* Security info */}
                <div className="bg-slate-900 border border-slate-700 rounded-lg p-4 flex items-start gap-3">
                  <svg
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-lg text-sm font-medium border border-slate-700 text-slate-400 hover:text-white hover:border-slate-500 transition"
                  >
                    Cancel
                  </button>
                  <button
              ...
              <div className="space-y-6">
                <div className="text-center py-8">
                  <div className="relative mx-auto w-20 h-20 mb-6">
                    ...
                    <div className="relative w-20 h-20 rounded-full bg-slate-800 border-2 border-cyan-500/50 flex items-center justify-center">
                      <svg
                ...
                <button
                  onClick={resetGrantFlow}
                  className="w-full py-2.5 rounded-lg text-sm font-medium border border-slate-700 text-slate-400 hover:text-white hover:border-slate-500 transition"
                >
            ...
            {grantStep === "ready" && grantStatus && (
              <div className="space-y-6">
                <div className="bg-green-500/5 border border-green-500/20 rounded-xl p-6 text-center">
                  ...
                  <div className="bg-slate-900 border border-slate-700 rounded-lg px-4 py-3 inline-block">
